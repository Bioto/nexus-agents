...
"""
increment_counter - Increments an internal counter and returns the new value
...
async def increment_counter() -> Dict[str, Any]:
    return await call_mcp_tool("increment_counter", {})
