...
impl Database {
    ...
    pub async fn new() -> Result<Self> {
        ...
        let service = ClickHouseService::new(config).await.map_err(|e| {
            RecorderError::Configuration(format!("Failed to create ClickHouse service: {}", e))
        })?;
    ...
    async fn init_schema(&self) -> Result<()> {
        ...
        self.service
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to create events table: {}", e)))?;
        ...
        self.service
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to create sessions table: {}", e)))?;
        ...
        self.service
            ...
            .await
            .map_err(|e| {
                RecorderError::Other(format!("Failed to create screenshots table: {}", e))
            })?;
        ...
        self.service
            ...
            .await
            .map_err(|e| {
                RecorderError::Other(format!("Failed to create key_frequency table: {}", e))
            })?;
    ...
    pub async fn create_session(&self, session_id: &str) -> Result<()> {
        ...
        self.service
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to create session: {}", e)))?;
    ...
    pub async fn insert_event(
        ...
        self.service
            .insert(&query)
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to insert event: {}", e)))?;
    ...
    pub async fn batch_insert_events(
        &self,
        events: &[super::batch_inserter::BatchEvent],
    ) -> Result<()> {
        if events.is_empty() {
            return Ok(());
        }
        ...
        self.service
            .insert(&query)
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to batch insert events: {}", e)))?;
    ...
    pub async fn insert_screenshot(
        ...
        self.service
            .insert(&query)
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to insert screenshot: {}", e)))?;
    ...
    pub async fn update_key_frequency(&self, session_id: &str, key: &str) -> Result<()> {
        ...
        self.service
            .insert(&query)
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to update key frequency: {}", e)))?;
    ...
    pub async fn update_mouse_button_frequency(
        ...
        self.service.insert(&query).await.map_err(|e| {
            RecorderError::Other(format!("Failed to update mouse button frequency: {}", e))
        })?;
    ...
    pub async fn end_session(&self, session_id: &str) -> Result<()> {
        ...
        let block = self
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to query session: {}", e)))?;
        ...
        if let Some(row) = block.rows().next() {
            ...
            self.service
                .insert(&update_query)
                .await
                .map_err(|e| RecorderError::Other(format!("Failed to end session: {}", e)))?;
        } else {
    ...
    pub async fn get_session_metrics(&self, session_id: &str) -> Result<Metrics> {
        ...
        let response = client
            ...
            .send()
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to send HTTP request: {}", e)))?;
        ...
        let text = response
            .text()
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to read HTTP response: {}", e)))?;
        ...
        for line in text.lines() {
            ...
            let row: serde_json::Value = serde_json::from_str(line)
                .map_err(|e| RecorderError::Other(format!("Failed to parse JSON row: {}", e)))?;

            start_time_str = row
                .get("start_time")
                .and_then(|v| v.as_str())
                .ok_or_else(|| RecorderError::Other("Failed to get start_time".to_string()))?
                .to_string();
            end_time_opt = row
                .get("end_time")
                .and_then(|v| v.as_str())
        ...
        let key_block = self
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to query key frequency: {}", e)))?;

        let mut key_frequency = HashMap::new();
        for row in key_block.rows() {
            let key: String = row
                .get("key")
                .map_err(|_| RecorderError::Other("Failed to get key".to_string()))?;
            let count: u64 = row
                .get("total")
                .map_err(|_| RecorderError::Other("Failed to get count".to_string()))?;
        ...
        for row in button_block.rows() {
            let button: String = row
                .get("button")
                .map_err(|_| RecorderError::Other("Failed to get button".to_string()))?;
            let count: u64 = row
                .get("total")
                .map_err(|_| RecorderError::Other("Failed to get count".to_string()))?;
    ...
    pub async fn get_screenshots_for_click(
        ...
        let block = self
            ...
            .await
            .map_err(|e| RecorderError::Other(format!("Failed to query screenshots: {}", e)))?;

        let mut results = Vec::new();
        for row in block.rows() {
            let id: String = row
                .get("id")
                .map_err(|_| RecorderError::Other("Failed to get screenshot id".to_string()))?;
            let file_path: String = row
                .get("file_path")
                .map_err(|_| RecorderError::Other("Failed to get file_path".to_string()))?;
            let frame_number: u64 = row
                .get("frame_number")
                .map_err(|_| RecorderError::Other("Failed to get frame_number".to_string()))?;
    ...
    pub async fn get_session_events(&self, session_id: &str) -> Result<Vec<TimelineEvent>> {
        ...
        for line in text.lines() {
            ...
            let event_type = row
                .get("event_type")
                .and_then(|v| v.as_str())
                .ok_or_else(|| RecorderError::Other("Missing event_type".to_string()))?
                .to_string();
            ...
            let timestamp_str = row
                .get("timestamp")
                .and_then(|v| v.as_str())
                .ok_or_else(|| RecorderError::Other("Missing timestamp".to_string()))?;
            ...
            let timestamp = match DateTime::parse_from_rfc3339(timestamp_str) {
                ...
                Err(_) => {
                    chrono::NaiveDateTime::parse_from_str(timestamp_str, "%Y-%m-%d %H:%M:%S%.f")
                        .map_err(|e| {
                            RecorderError::Other(format!("Failed to parse timestamp: {}", e))
                        })?
                        .and_utc()
                }
            };
